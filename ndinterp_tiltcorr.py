...
if lsq:
    ...
    #Write out copy of the mask for later reference
    f_fn = os.path.splitext(stack_fn)[0]+'_tiltcorr_mask.tif'
    iolib.writeGTiff(validmask,f_fn,gt=gt,proj=stack.proj) 
